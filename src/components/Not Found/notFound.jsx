        ...
        <section className="">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[180px] pt-12 lg:pb-28 pb-12">
                    <div className=" h-[550px] rounded-lg w-full">

                        <div className="border border-red-200 rounded-md w-full relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
                            <svg
                                width={314}
                                height={171}
                                viewBox="0 0 314 171"
                            ...
                            >
                                ...
                                <path
                                    ...
                                    fill="#dc2626"
                                />
                                <circle cx="136.191" cy="31.0854" r="1.36752" fill="#dc2626" />
                                <circle cx="141.661" cy="31.0854" r="1.36752" fill="#dc2626" />
                                <circle cx="147.131" cy="31.0854" r="1.36752" fill="#dc2626" />
                            </svg>
